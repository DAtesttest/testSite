...
var pr4 = ['./img/arch/sem2/full/sculpture1/sculpture101.jpg', './img/arch/sem2/full/sculpture1/sculpture102.jpg'];
...
var photoNewYorkPreview = ['./img/PictureByGallery/NewYork/preview/IMG_9020.jpg', './img/PictureByGallery/NewYork/preview/IMG_8867.jpg', './img/PictureByGallery/NewYork/preview/IMG_9651.jpg', './img/PictureByGallery/NewYork/preview/IMG_9087.jpg', './img/PictureByGallery/NewYork/preview/IMG_9523.jpg', './img/PictureByGallery/NewYork/preview/newyork.jpg'];
...
//Name Arrays
var targetArray = [sem1Preview, sem2Preview, sem3Preview, sem4Preview, pr1, pr2, pr3, pr4, pr5, pr6, pr7, pr8, pr9, pr10, pr11, pr12, photoAmsterdamPreview, photoBelgiumPreview, photoBerlinPreview, photoBoliviaPreview, photoFrancePreview, photoNewYorkPreview, photoAmsterdam, photoBelgium, photoBerlin, photoBolivia,  photoFrance, photoNewYork];
var nameArray = [sem1Preview.name, sem2Preview.name, sem3Preview.name, sem4Preview.name, pr1.name,  pr2.name, pr3.name, pr4.name, pr5.name, pr6.name, pr7.name, pr8.name, pr9.name, pr10.name, pr11.name, pr12.name, photoAmsterdam, photoBelgium, photoBerlin, photoBolivia, photoFrance, photoNewYork];
pr1.name = "pr1";
pr2.name = "pr2";
pr3.name = "pr3";
pr4.name = "pr4";
